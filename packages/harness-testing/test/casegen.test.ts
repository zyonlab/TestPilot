...
describe("给模型的 schema 与给我们的校验必须对齐", () => {
  ...
  const filledByHarness: Record<string, string> = {
    ...
    /**
     * 这两个是**另一条生成路径**的字段（2026-09-11 单元循环，docs/v3/history/22）。
    ...
    /**
     * v2 设计证据的八个字段（2026-09-11，docs/v3/history/21 §2 与 §5）。
     *
...
/**
 * v2 设计证据（docs/v3/history/21 §2 与 §5）。八个字段全是可选的，所以这些检查只在字段出现时触发——
