...
const STORY_CONTRACT=[
  ...
  'TWO KINDS OF UNKNOWN, LABELLED DIFFERENTLY: 【待确认：界面观察不到】 is a coverage gap — the domain knowledge raises a question this observation cannot answer. 【待确认：与领域知识冲突】 is a product defect lead — two materials, or a material and the screen, say different things; name both sections. Volatile readings (mark price, funding rate, countdown, 24h volume) may only be asserted as existing or as a relation between two readings.',
